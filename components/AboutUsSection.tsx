          ...
          <div className={`flex justify-between  `}>
            ...
            >
              ...
              <div className="w-full flex justify-start mt-[2rem]">
                <button className="shadow-lg text-center lg:px-[1.5rem] px-[1rem] lg:py-[12px] py-[8px] text-[12px] lg:text-[20px] bg-primary-color text-[white] font-[500] rounded-full transition-all duration-500  hover:translate-y-[-20%] ">
                  Learn more
                </button>
              </div>
            </div>
